...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('pending_payment', 'paid', 'cancelled', 'expired', name='booking_status'), server_default='pending_payment', nullable=False),
    ...
    sa.Column('status', sa.Enum('available', 'reserved', 'sold', name='seat_status'), server_default='available', nullable=False),
